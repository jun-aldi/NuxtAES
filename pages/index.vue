      ...
      if (this.essays === "" && this.questions === "") {
        ...
        fetch("/api/gpt3", {
          ...
          .then((data) => {
            ...
            // Extracting values
            this.score = extractValue(scoreRegex, this.result);
            this.correction = extractValue(correctionRegex, this.result);
            this.confidenceScore = extractValue(confidenceRegex, this.result);
