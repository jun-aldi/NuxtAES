<template>
  <div>
    <section class="bg-white dark:bg-gray-900">
      <div class="max-w-screen-xl px-4 py-4 mx-auto lg:py-16">
        <div
  ...
  methods: {
    gpt3() {
      fetch("/api/gpt3", {
        ...
        body: JSON.stringify({
          textGPT:
            "You is computer teacher. i would like you to score an ANSWER written by Bahasa Indonesia. Each ANSWER is assigned a rating of 0 to 10, with 10 being the highest and 0 the lowest. The ANSWER is scored based on the following QUESTION. and give me confidence score when scoring that ANSWER. Format response {score: (score) correction: (correction in bahasa) confidence score: (confidence score with precentage)} --QEUSTION-- " +
            this.questions +
            " --QEUSTION-- " +
            " \n--ANSWER-- " +
            this.essays +
